...
class Agglomerative_Cluster_Model():

    def __init__(self) -> None:
        pass

    def agglomerative_clustering(self, contours:list, threshold_distance=40.0):
        while len(contours) > 1:
            ...
            if min_distance < threshold_distance:
                ...
                contours[index1] = merge_contours(contours[index1], contours[index2])
                del contours[index2]
            else: 
                break
